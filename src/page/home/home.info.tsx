...
export const Information: React.FC = () => {
  return (
    <InfoStyle className="relative h-full main-content">
      <div className="relative">
        <img src={`${process.env.PUBLIC_URL}/assets/img-cover-info.png`} className="h-48 w-full" alt="cover" />
      ...
      <div className="absolute bottom-0 left-0 w-full">
        <img
          src={`${process.env.PUBLIC_URL}/assets/img-bottom-info.png`}
          alt="bottom info"
